define(["require", "exports", "../../Styling"], function (require, exports, Styling_1) {
    ...
    var bounceAnimation = Styling_1.keyframes({
    ...
    var opacityFadeIn = Styling_1.keyframes({
        '0%': {
            opacity: 0,
            animationTimingFunction: Styling_1.AnimationVariables.easeFunction2
        },
        '26.26%': { opacity: 1 },
        '100%': { opacity: 1 }
    });
        ...
        return {
            ...
            header: [
                ...
                (hasCondensedHeadline || hasSmallHeadline) && [
                    Styling_1.DefaultFontStyles.medium,
                    {
                        marginRight: '10px',
            ...
            headline: [
                ...
                hasLargeHeadline && [
                    Styling_1.DefaultFontStyles.xxLarge,
                    {
